...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports={utils:__webpack_require__(1),DataFrame:__webpack_require__(4)};
...
/***/ function(module, exports, __webpack_require__) {
	...
	!function(){"use strict";function t(t,n){var r=String(t);return r.length!==n.length&&(r=(n+r).substr(r.length,n.length)),r}function n(t,n){for(var r=String(t);r.length<n;)r="0"+r;return r}function r(t,n){return t?new Date(Date.UTC.apply(null,n)):u.new_Object(Date,n)}function e(t,n){for(var e in a){var i=a[e].regexp.exec(n);if(i){for(var s=[],u=1;u<i.length;u++)s[u-1]=+i[u];return s[1]--,r(t,s)}}}function i(t,n){return t===n?null:n>t?-1:1}function s(t,n){o.assign(this,n),this.mixin_type=function(){return this.mixin?this.mixin.type:void 0};var r=this.mixin_type();r&&o.defaults(this,r),this.name=t,o.defaults(this,{order:i,missing:o.isNull,coerce:function(t,n){if(this.is(t))return t;n=n||u.findTypeByValue(t);var r="to_"+this.name;if(n.hasOwnProperty(r))return n[r](t);var e="from_"+n.name;if(this.hasOwnProperty(e))return this[e](t);var i=this.mixin_type();if(i&&i===n.mixin_type())return this.mixin_coerce(t,n);var s=n.to_string(t);return this.from_string(s)},_to_string:u.ensureString,to_string:function(t){return o.isNull(t)?"":this._to_string(t)}}),this.compare=u.orderNullsFirst(this.order)}var u=module.exports={},o=__webpack_require__(2);u.isUint32=function(t){return o.isNumber(t)&&t>=0&&4294967295>=t&&t%1===0},u.testFor=function(t,n,r){return u.assert(n,["some","every"]),Array.prototype[n].call(r,function(n){return n(t)})},u.isNullish=function(t){return o.isNull(t)||o.isUndefined(t)},u.isPrimitive=function(t){return o.isString(t)||o.isNumber(t)||o.isBoolean(t)||o.isFunction(t)||o.isDate(t)},u.isArrayEmpty=function(t){return u.isNullish(t)||o.isArray(t)&&0===t.length},u.isStringEmpty=function(t){return u.isNullish(t)||o.isString(t)&&0===t.trim().length},u.isStringNotEmpty=function(t){return o.isString(t)&&t.trim().length>0},u.numDefault=function(t,n){return u.isNullish(t)||isNaN(t)?n:t},u.brodcastCall=function(t,n,r,e){e=e||!1,u.isArrayEmpty(t)||t.forEach(function(t){var i=t[n];if(o.isFunction(i))i.apply(t,r);else if(e)throw u.error({message:"No such function",funcName:n,obj:t})})},u.new_Object=function(t,n){var r=[null];return Array.prototype.push.apply(r,n),new(Function.prototype.bind.apply(t,r))},u.extractFunctionName=function(t){var n=t.toString().match(/^\s*function\s*([^\s(]+)/);return n?n[1]:""},u.getPropertyExtractor=function(t){return function(n){return n[t]}},u.combineKeyExtractors=function(){var t=u.extractArray(arguments);return function(n){for(var r=0;r<t.length;r++){var e=t[r](n);if(void 0!==e)return e}}},u.extractArray=function(t){if(!t||0===t.length)return[];if(1===t.length){var n=t[0];if(o.isArray(n))return n}return Array.prototype.slice.call(t)},u.binarySearch=function(t,n,r,e){for(var i,s,u=e||function(t){return t},o=0,a=n.length-1;a>=o;)if(i=(o+a)/2|0,s=r(t,u(n[i])),s>0)o=i+1;else{if(!(0>s))return i;a=i-1}return-1-o},u.repeat=function(t,n){for(var r=[],e=0;t>e;e++)r.push(o.isFunction(n)?n(e):n);return r},u.convertListToObject=function(t,n){for(var r={},e=0;e<t.length;e++){var i=t[e],s=n(i);void 0!==s&&(r[s]=i)}return r},u.convertFunctionsToObject=function(t){return u.convertListToObject(t,u.combineKeyExtractors(u.getPropertyExtractor("name"),u.extractFunctionName))},u.applyOnAll=function(t,n){for(var r in t)t.hasOwnProperty(r)&&n(t[r],r,t)},u.join=function(t,n,r){var e=o.isArray(t)||o.isTypedArray(t)?t:Object.keys(t);r||(r=function(t){return t}),u.isNullish(n)&&(n=",");var i=n;o.isFunction(n)||(i=function(t,r,e){return 0>r||0>e?"":n});for(var s=-1,a=e.length-1,f="";s<e.length;)s>=0&&(f+=r(e[s],t)),f+=i(e,s,a,t),s++,a--;return f},u.filterChars=function(t,n){for(var r=0;r<t.length&&n(t.charAt(r),r,t);)r++;return r},u.detectRepeatingChar=function(t,n){return u.filterChars(t,function(t){return t===n})},u.detectPrefix=function(t,n){return n.length===u.filterChars(t,function(t,r){return t===n.charAt(r)})},u.ensureString=function(t){return o.isString(t)?t:String(t)},u.error=function(t,n){return n=n||new Error,t=t||{},u.isNullish(n._message)&&(n._message=n.message?n.message:t.message||"",delete t.message),o.isPlainObject(n.params)?o.assign(n.params,t):n.params=t,n.toString=function(){var t=n._message;return o.size(this.params)?t+" "+JSON.stringify(this.params):t},n},u.assert=function(t,n,r){function e(n){return t===n}var i=o.isArray(n)?n.some(e):e(n);if(!i)throw u.error({message:r||"Unexpected value",expected:n,provided:t})};var a={YYYY_MM_DDThh_mm_ss_zzzZ:{delims:["-","-","T",":",":",".","Z"]},YYYY_MM_DDThh_mm_ss_zzz:{delims:["-","-","T",":",":","."]},YYYY_MM_DD_hh_mm_ss_zzz:{delims:["-","-"," ",":",":","."]},YYYY_MM_DDThh_mm_ss:{delims:["-","-","T",":",":"]},YYYY_MM_DD_hh_mm_ss:{delims:["-","-"," ",":",":"]},YYYYMMDD_hhmmss:{delims:["","","-","",""]},YYYYMMDDhhmmss:{delims:["","","","",""]},YYYY_MM_DD:{delims:["-","-"]},YYYYMMDD:{delims:["",""]}},f=[4,2,2,2,2,2,3],c=f.map(function(t){for(var n="(";t--;)n+="\\d";return n+")"});for(var l in a){for(var h=a[l],g=h.delims.length+1,m="^",p=0;g>p;p++){p>0&&(m+=h.delims[p-1]);var y=c[p];y&&(m+=y)}m+="$",h.regexp=new RegExp(m)}u.date_from_string=function(t,n,r){n=n||1;var i=e(!0,t);if(o.isDate(i)){var s=i.getTime(),u=s%n;if(0===u)return i;if(!r)return new Date(s-u)}},u.date_components=function(t){return[t.getFullYear(),t.getMonth()+1,t.getDate(),t.getHours(),t.getMinutes(),t.getSeconds(),t.getMilliseconds()]},u.utc_components=function(t){return[t.getUTCFullYear(),t.getUTCMonth()+1,t.getUTCDate(),t.getUTCHours(),t.getUTCMinutes(),t.getUTCSeconds(),t.getUTCMilliseconds()]},u.SUPPORTED_DATE_FORMATS=Object.keys(a),u.date_to_string_fn=function(t,r){r=r||u.utc_components;var e=a[t].delims;return function(t){for(var i=r(t),s=e.length+1,u="",o=0;s>o;o++)o>0&&(u+=e[o-1]),o<i.length&&(u+=n(i[o],f[o]));return u}},u.parseDateUTC=function(t){return e(!0,t)},u.parseDate=function(t){return e(!1,t)},u.relativeDateString=function(n,r){if(!o.isDate(n)){if(u.isNullish(n))return"";n=u.parseDateUTC(n)}if(o.isDate(r)||(r=new Date),Math.abs(n.getTime()-r.getTime())<864e5){var e=Math.floor((n.getTime()-r.getTime())/1e3),i=Math.abs(e)+30,s=Math.floor(i/60),a=Math.floor(s/60);return i%=60,s%=60,(0>e?"-":"+")+t(a,"00")+":"+t(s,"00")}return n.getUTCFullYear()+"-"+t(n.getUTCMonth()+1,"00")+"-"+t(n.getUTCDate(),"00")+" "+t(n.getUTCHours(),"00")+":"+t(n.getUTCMinutes(),"00")},u.BiMap=function(t){function n(){if(null===e){e={};for(var t in r)r.hasOwnProperty(t)&&(e[r[t]]=t)}return e}if(!(this instanceof u.BiMap))return new u.BiMap(t);var r=t||{},e=null;this.get=function(t){return r[t]},this.key=function(t){return n()[t]},this.put=function(t,n){r[t]=n,e=null},this.del=function(t){delete r[t],e=null},this.keys=function(){return Object.keys(r)},this.values=function(){return Object.keys(n())}},u.Tokenizer=function(t,n){function r(){return n.indexOf(t.charAt(i))<0}function e(n){for(var r=i;i<t.length&&n();)i++;return t.substring(r,i)}var i=0;return{getText:function(){return t},nextValue:function(){return e(r)},nextDelimiter:function(){return e(function(){return!r()})},toString:function(){return t.substring(0,i)+" <-i-> "+t.substring(i)},getPosition:function(){return i},setPosition:function(t){i=t}}},u.splitUrlPath=function(t){var n=t.split("/"),r=n[n.length-1].split("?"),e={path:n,variables:{},toString:function(){var t="",n="?";for(var r in this.variables)this.variables.hasOwnProperty(r)&&(t+=n+r+"="+encodeURI(this.variables[r]),n="&");return this.path.join("/")+t}};if(2===r.length)n[n.length-1]=r[0],r[1].split("&").forEach(function(t){var n=t.split("=");n[0].length>0&&(e.variables[n[0]]=decodeURIComponent(n[1]))});else if(r.length>2)throw'Unexpected number of "?" in url :'+t;return e},u.orderChain=function(){var t=u.extractArray(arguments);return function(n,r){for(var e=0,i=0;i<t.length;i++){var s=t[i](n,r);if(null!==s){e=s;break}}return e}},u.orderPredicateFirst=function(t){return function(n,r){return t(n)?t(r)?0:-1:t(r)?1:null}},u.indexOrder=function(t,n){return function(r,e){return t(n[r],n[e])}},u.extractValuesByIndex=function(t,n){return t.map(function(t){return n[t]})},u.createIndex=function(t){return o.range(t.length)},u.orderInverse=function(t){return function(n,r){return t(r,n)}},u.orderNullsFirst=function(){var t=u.extractArray(arguments);return t.splice(0,0,u.orderPredicateFirst(o.isUndefined)),t.splice(1,0,u.orderPredicateFirst(o.isNull)),u.orderChain(t)},u.types={},s.prototype.init=function(){this.to={},this.from={}},u.Type=s,u.addTypes=function(t){for(var n in t)t.hasOwnProperty(n)&&(u.types[n]=new s(n,t[n]));for(n in u.types)u.types.hasOwnProperty(n)&&u.types[n].init()};var _=[null,"","NaN","null"],d=["0","1","n","y","f","t","no","yes","false","true"],v=864e5,Y=1e3,D={is:function(t){return o.isDate(t)&&t.getTime()%this.mixin.precision===0},from_string:function(t,n){return u.isNullish(t)||""===t?null:u.date_from_string(t,this.mixin.precision,n)},_to_string:function(t){return u.date_to_string_fn(this.mixin.pattern)(t)},from_number:function(t){return isNaN(t)||u.isNullish(t)?null:new Date(t-t%this.mixin.precision)},to_number:function(t){return u.isNullish(t)?NaN:t.getTime()},order:function(t,n){return i(t.getTime(),n.getTime())},mixin_coerce:function(t,n){return this.from_number(n.to_number(t))}};u.addTypes({string:{is:o.isString,missing:function(t){return u.isNullish(t)||""===t},from_string:function(t){return""===t?null:t}},number:{is:o.isNumber,missing:isNaN,from_string:function(t){return _.indexOf(t)>-1?NaN:u.numDefault(+t,void 0)},_to_string:function(t){return isNaN(t)?"":String(t)}},"boolean":{is:o.isBoolean,from_string:function(t,n){if(o.isNull(t)||""===t)return null;if(o.isString(t)){var r=d.indexOf(t.toLowerCase());if(r>=0)return r%2===1}if(!n){var e=+t;if(!isNaN(e))return Math.abs(e)>1e-8}},to_number:function(t){return u.isNullish(t)?NaN:+t},order:function(t,n){return t?n?null:1:n?-1:null}},date:{mixin:{type:D,precision:v,pattern:"YYYY_MM_DD"}},datetime:{mixin:{type:D,precision:Y,pattern:"YYYY_MM_DD_hh_mm_ss"}},timestamp:{mixin:{type:D,precision:1,pattern:"YYYY_MM_DD_hh_mm_ss_zzz"}}}),u.detect_possible_array_types=function(t){var n={string:{array:t,hasMissing:!1,type:u.types.string}},r=["date","datetime","boolean","number"];return r.forEach(function(r){n[r]={array:new Array(t.length),hasMissing:!1,type:u.types[r]}}),t.forEach(function(t,e){u.types.string.missing(t)&&(n.string.hasMissing=!0);for(var i=0;i<r.length;){var s=r[i],a=n[s],f=a.type.from_string(t,!0);a.type.missing(f)&&(a.hasMissing=!0),o.isUndefined(f)?(delete n[s],r.splice(i,1)):(a.array[e]=f,i++)}}),n};var b=["number","date","datetime","timestamp","boolean","string"];u.findTypeByValue=function(t){for(var n in u.types)if(u.types.hasOwnProperty(n)){var r=u.types[n];if(r.is(t))return r}return u.types.string},u.choose_column_type=function(t){var n=Object.keys(t);if(1==n.length)return t[n[0]];for(var r=0;r<b.length;r++)if(t.hasOwnProperty(b[r]))return t[b[r]]},u.ensureType=function(t){return t instanceof s?t:u.types[t]}}();
	//# sourceMappingURL=out.map.js
...
/***/ function(module, exports, __webpack_require__) {
	...
	!function(){"use strict";function t(t,n){return n=n||{columns:t.shift()},new s(t,n)}function n(t){var n,e,r,o=[],i=!1;for(n=e=r=0;r<t.length;r++){var u=t[r],s=t[r+1];o[n]=o[n]||[],o[n][e]=o[n][e]||"",'"'===u&&i&&'"'===s?(o[n][e]+=u,++r):'"'!==u?","!==u||i?"\n"!==u||i?o[n][e]+=u:(++n,e=0):++e:i=!i}return o}function e(t){return[].map.call(t.rows,function(t){return[].map.call(t.cells,function(t){return t.textContent})})}var r=__webpack_require__(1),o=__webpack_require__(2),i=function(t,n,e){this.name=t,this.data=[],n&&(this.data.length=n),this.type=e};i.prototype.set=function(t,n){this.type&&!this.type.is(n)&&(n=this.type.coerce(n)),this.data[t]=n};var u=function(){this.byIndex=[],this.byName={}};u.prototype.getColumn=function(t){return(o.isNumber(t)?this.byIndex:this.byName)[t]},u.prototype.enforceColumn=function(t,n,e){var o=this.byName[t];return r.isNullish(o)&&(o=new i(t,n,e),o.col_idx=this.byIndex.length,this.byIndex.push(o),this.byName[t]=o),o},u.prototype.enforceColumnAt=function(t,n,e){var o=this.byIndex[t];if(r.isNullish(o)){var u="c"+t;o=new i(u,n,e),o.col_idx=t,this.byIndex[t]=o,this.byName[u]=o}return o},u.prototype.addColumns=function(t,n){for(var e=0;e<t.length;e++){var i,u=t[e];o.isPlainObject(t[e])&&(u=t[e].name,i=r.ensureType(t[e].type)),this.enforceColumn(u,n,i)}return this};var s=function(t,n){var e=this;if(o.isUndefined(e)||e.constructor!==s)return new s(t,n);n=n||{},t=t||[],this.columnSet=(new u).addColumns(n.columns||[],t.length),this.index=o.range(t.length);for(var r=0;r<t.length;r++){var i=t[r];if(o.isPlainObject(i))for(var a=Object.keys(i),h=0;h<a.length;h++)this.columnSet.enforceColumn(a[h]).set(r,i[a[h]]);else{if(!o.isArray(i))throw{msg:"row should be object or array and not:"+i};for(var c=0;c<i.length;c++)this.columnSet.enforceColumnAt(c).set(r,i[c])}}return e};s.parse_csv=function(e,r){return t(n(e),r)},s.parse_wdf=function(t){var n=t.split("\n"),e=JSON.parse(n.shift());return new s(n.filter(r.isStringNotEmpty).map(JSON.parse),e)},s.parse_dom_table=function(n,r){return t(e(n),r)},s.prototype.getRow=function(t,n){var e=this.index[t];return n=n||{},this.columnSet.byIndex.forEach(o.isArray(n)?function(t,r){n[r]=t.data[e]}:function(t){n[t.name]=t.data[e]}),n},s.prototype.get=function(t,n){var e=this.index[t],r=this.columnSet.getColumn(n);return r.data[e]},s.prototype.set=function(t,n,e){var r=this.index[t],o=this.columnSet.getColumn(n);o.data[r]=e},s.prototype.getRowCount=function(){return this.index.length},s.prototype.newRow=function(){var t=this.index.length;return this.index[t]=t,t},s.prototype.deleteRow=function(t){this.index.splice(t,1)},s.prototype.getColumn=function(t){var n=this.columnSet.getColumn(t);return n?this.index.map(function(t){return n.data[t]}):void 0},s.prototype.apply=function(t){for(var n=0;n<this.index.length;n++)t(this,n)},s.prototype.map=function(t){for(var n,e=[],r=0;r<this.index.length;r++)n=t(this,r),void 0!==n&&e.push(n);return e},s.prototype.getData=function(){for(var t={columns:[],rows:[]},n=this.columnSet.byIndex,e=0;e<n.length;e++){var r=n[e],o={name:r.name};r.type&&(o.type=r.type.name),t.columns.push(o)}return t.rows=this.map(function(t,n){return t.getRow(n,[])}),t},s.prototype.getObjects=function(){return this.map(function(t,n){return t.getRow(n)})},module.exports=s}();
	//# sourceMappingURL=out.map.js
