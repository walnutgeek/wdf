...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";function pad_with(t,n){var r=String(t);return r.length!==n.length&&(r=(n+r).substr(r.length,n.length)),r}function pad_with_zeros(t,n){for(var r=String(t);r.length<n;)r="0"+r;return r}function new_date(t,n){return t?new Date(Date.UTC.apply(null,n)):u$.new_Object(Date,n)}function parse_date(t,n){for(var r in DATE_PATTERNS){var e=DATE_PATTERNS[r].regexp.exec(n);if(e)return new_date(t,4===e.length?[+e[1],e[2]-1,+e[3]]:[+e[1],e[2]-1,+e[3],+e[4],+e[5],+e[6]])}}function generic_order(t,n){return t===n?null:n>t?-1:1}function Type(t,n){this.name=t,this.is=n.is,this.from_string=n.from_string,this.notnull_to_string=n.notnull_to_string||u$.ensureString,this.to_string=n.to_string||function(t){return u$.isNullish(t)?"":this.notnull_to_string(t)},this.missing=n.missing||_.isNull,this.order=n.order||generic_order,this.compare=u$.orderNullsFirst(this.order),u$.types[t]=this}var u$=module.exports={},_=__webpack_require__(2);u$.isUint32=function(t){return _.isNumber(t)&&t>=0&&4294967295>=t&&t%1===0},u$.testFor=function(t,n,r){return u$.assert(n,["some","every"]),Array.prototype[n].call(r,function(n){return n(t)})},u$.isNullish=function(t){return _.isNull(t)||_.isUndefined(t)},u$.isPrimitive=function(t){return _.isString(t)||_.isNumber(t)||_.isBoolean(t)||_.isFunction(t)||_.isDate(t)},u$.isArrayEmpty=function(t){return u$.isNullish(t)||_.isArray(t)&&0===t.length},u$.isStringEmpty=function(t){return u$.isNullish(t)||_.isString(t)&&0===t.trim().length},u$.numDefault=function(t,n){return u$.isNullish(t)||isNaN(t)?n:t},u$.brodcastCall=function(t,n,r,e){e=e||!1,u$.isArrayEmpty(t)||t.forEach(function(t){var i=t[n];if(_.isFunction(i))i.apply(t,r);else if(e)throw u$.error({message:"No such function",funcName:n,obj:t})})},u$.new_Object=function(t,n){var r=[null];return Array.prototype.push.apply(r,n),new(Function.prototype.bind.apply(t,r))},u$.extractFunctionName=function(t){var n=t.toString().match(/^\s*function\s*([^\s(]+)/);return n?n[1]:""},u$.getPropertyExtractor=function(t){return function(n){return n[t]}},u$.combineKeyExtractors=function(){var t=u$.extractArray(arguments);return function(n){for(var r=0;r<t.length;r++){var e=t[r](n);if(void 0!==e)return e}}},u$.extractArray=function(t){if(!t||0===t.length)return[];if(1===t.length){var n=t[0];if(_.isArray(n))return n}return Array.prototype.slice.call(t)},u$.binarySearch=function(t,n,r,e){for(var i,u,s=e||function(t){return t},o=0,a=n.length-1;a>=o;)if(i=(o+a)/2|0,u=r(t,s(n[i])),u>0)o=i+1;else{if(!(0>u))return i;a=i-1}return-1-o},u$.repeat=function(t,n){for(var r=[],e=0;t>e;e++)r.push(_.isFunction(n)?n(e):n);return r},u$.convertListToObject=function(t,n){for(var r={},e=0;e<t.length;e++){var i=t[e],u=n(i);void 0!==u&&(r[u]=i)}return r},u$.convertFunctionsToObject=function(t){return u$.convertListToObject(t,u$.combineKeyExtractors(u$.getPropertyExtractor("name"),u$.extractFunctionName))},u$.applyOnAll=function(t,n){for(var r in t)t.hasOwnProperty(r)&&n(t[r],r,t)},u$.join=function(t,n,r){var e=_.isArray(t)||_.isTypedArray(t)?t:Object.keys(t);r||(r=function(t){return t}),u$.isNullish(n)&&(n=",");var i=n;_.isFunction(n)||(i=function(t,r,e){return 0>r||0>e?"":n});for(var u=-1,s=e.length-1,o="";u<e.length;)u>=0&&(o+=r(e[u],t)),o+=i(e,u,s,t),u++,s--;return o},u$.filterChars=function(t,n){for(var r=0;r<t.length&&n(t.charAt(r),r,t);)r++;return r},u$.detectRepeatingChar=function(t,n){return u$.filterChars(t,function(t){return t===n})},u$.detectPrefix=function(t,n){return n.length===u$.filterChars(t,function(t,r){return t===n.charAt(r)})},u$.ensureString=function(t){return _.isString(t)?t:String(t)},u$.error=function(t,n){return n=n||new Error,t=t||{},u$.isNullish(n._message)&&(n._message=n.message?n.message:t.message||"",delete t.message),_.isPlainObject(n.params)?_.assign(n.params,t):n.params=t,n.toString=function(){var t=n._message;return _.size(this.params)?t+" "+JSON.stringify(this.params):t},n},u$.assert=function(t,n,r){function e(n){return t===n}var i=_.isArray(n)?n.some(e):e(n);if(!i)throw u$.error({message:r||"Unexpected value",expected:n,provided:t})};var DATE_PATTERNS={YYYY_MM_DDThh_mm_ss:{delims:["-","-","T",":",":"]},YYYY_MM_DD_hh_mm_ss:{delims:["-","-"," ",":",":"]},YYYYMMDD_hhmmss:{delims:["","","-","",""]},YYYYMMDDhhmmss:{delims:["","","","",""]},YYYY_MM_DD:{delims:["-","-"]},YYYYMMDD:{delims:["",""]}},DATE_FIELD_SIZES=[4,2,2,2,2,2],pattern_texts=DATE_FIELD_SIZES.map(function(t){for(var n="(";t--;)n+="\\d";return n+")"});for(var name in DATE_PATTERNS){for(var o=DATE_PATTERNS[name],n=o.delims.length+1,s="",i=0;n>i;i++)i>0&&(s+=o.delims[i-1]),s+=pattern_texts[i];o.regexp=new RegExp(s)}u$.date_from_string=function(t){var n=parse_date(!0,t);return n&&0===n.getTime()%864e5?n:void 0},u$.datetime_from_string=function(t){return parse_date(!0,t)},u$.date_components=function(t){return[t.getFullYear(),t.getMonth()+1,t.getDate(),t.getHours(),t.getMinutes(),t.getSeconds()]},u$.utc_components=function(t){return[t.getUTCFullYear(),t.getUTCMonth()+1,t.getUTCDate(),t.getUTCHours(),t.getUTCMinutes(),t.getUTCSeconds()]},u$.SUPPORTED_DATE_FORMATS=Object.keys(DATE_PATTERNS),u$.date_to_string_fn=function(t,n){n=n||u$.utc_components;var r=DATE_PATTERNS[t].delims;return function(t){for(var e=n(t),i=r.length+1,u="",s=0;i>s;s++)s>0&&(u+=r[s-1]),u+=pad_with_zeros(e[s],DATE_FIELD_SIZES[s]);return u}},u$.dateToIsoString=function(t){return t.toISOString()},u$.parseDateUTC=function(t){return parse_date(!0,t)},u$.parseDate=function(t){return parse_date(!1,t)},u$.relativeDateString=function(t,n){if(!_.isDate(t)){if(u$.isNullish(t))return"";t=u$.parseDateUTC(t)}if(_.isDate(n)||(n=new Date),Math.abs(t.getTime()-n.getTime())<864e5){var r=Math.floor((t.getTime()-n.getTime())/1e3),e=Math.abs(r)+30,i=Math.floor(e/60),u=Math.floor(i/60);return e%=60,i%=60,(0>r?"-":"+")+pad_with(u,"00")+":"+pad_with(i,"00")}return t.getUTCFullYear()+"-"+pad_with(t.getUTCMonth()+1,"00")+"-"+pad_with(t.getUTCDate(),"00")+" "+pad_with(t.getUTCHours(),"00")+":"+pad_with(t.getUTCMinutes(),"00")},u$.BiMap=function(t){function n(){if(null===e){e={};for(var t in r)r.hasOwnProperty(t)&&(e[r[t]]=t)}return e}if(!(this instanceof u$.BiMap))return new u$.BiMap(t);var r=t||{},e=null;this.get=function(t){return r[t]},this.key=function(t){return n()[t]},this.put=function(t,n){r[t]=n,e=null},this.del=function(t){delete r[t],e=null},this.keys=function(){return Object.keys(r)},this.values=function(){return Object.keys(n())}},u$.Tokenizer=function(t,n){function r(){return n.indexOf(t.charAt(i))<0}function e(n){for(var r=i;i<t.length&&n();)i++;return t.substring(r,i)}var i=0;return{getText:function(){return t},nextValue:function(){return e(r)},nextDelimiter:function(){return e(function(){return!r()})},toString:function(){return t.substring(0,i)+" <-i-> "+t.substring(i)},getPosition:function(){return i},setPosition:function(t){i=t}}},u$.splitUrlPath=function(t){var n=t.split("/"),r=n[n.length-1].split("?"),e={path:n,variables:{},toString:function(){var t="",n="?";for(var r in this.variables)this.variables.hasOwnProperty(r)&&(t+=n+r+"="+encodeURI(this.variables[r]),n="&");return this.path.join("/")+t}};if(2===r.length)n[n.length-1]=r[0],r[1].split("&").forEach(function(t){var n=t.split("=");n[0].length>0&&(e.variables[n[0]]=decodeURIComponent(n[1]))});else if(r.length>2)throw'Unexpected number of "?" in url :'+t;return e},u$.types={},u$.Type=Type,u$.orderChain=function(){var t=u$.extractArray(arguments);return function(n,r){for(var e=0,i=0;i<t.length;i++){var u=t[i](n,r);if(null!==u){e=u;break}}return e}},u$.orderPredicateFirst=function(t){return function(n,r){return t(n)?t(r)?0:-1:t(r)?1:null}},u$.indexOrder=function(t,n){return function(r,e){return t(n[r],n[e])}},u$.extractValuesByIndex=function(t,n){return t.map(function(t){return n[t]})},u$.createIndex=function(t){return _.range(t.length)},u$.orderInverse=function(t){return function(n,r){return t(r,n)}},u$.orderNullsFirst=function(){var t=u$.extractArray(arguments);return t.splice(0,0,u$.orderPredicateFirst(_.isUndefined)),t.splice(1,0,u$.orderPredicateFirst(_.isNull)),u$.orderChain(t)},u$.addTypes=function(t){for(var n in t)t.hasOwnProperty(n)&&new Type(n,t[n])};var NANs=["","NaN","null"],BOOLEAN_STRINGS=["0","1","n","y","f","t","no","yes","false","true"];u$.addTypes({string:{is:_.isString,missing:function(t){return u$.isNullish(t)||""===t},from_string:function(t){return""===t?null:t}},number:{is:_.isNumber,missing:isNaN,from_string:function(t){return NANs.indexOf(t)>-1?NaN:u$.numDefault(+t,void 0)},notnull_to_string:function(t){return isNaN(t)?"":t}},"boolean":{is:_.isBoolean,from_string:function(t){if(""===t)return null;var n=BOOLEAN_STRINGS.indexOf(t.toLowerCase());return 0>n?void 0:n%2===1},order:function(t,n){return t?n?null:1:n?-1:null}},datetime:{is:_.isDate,from_string:function(t){return""===t?null:u$.datetime_from_string(t)},notnull_to_string:u$.date_to_string_fn("YYYY_MM_DD_hh_mm_ss"),order:function(t,n){return generic_order(t.valueOf(),n.valueOf())}},date:{is:_.isDate,from_string:function(t){return""===t?null:u$.date_from_string(t)},notnull_to_string:u$.date_to_string_fn("YYYY_MM_DD"),order:function(t,n){return generic_order(t.valueOf(),n.valueOf())}}}),u$.detect_possible_array_types=function(t){var n={string:{array:t,hasMissing:!1,type:"string"}},r=["date","datetime","boolean","number"];return r.forEach(function(t){n[t]={array:[],hasMissing:!1,type:t}}),t.forEach(function(t,e){u$.types.string.missing(t)&&(n.string.hasMissing=!0);for(var e=0;e<r.length;){var i=r[e],u=u$.types[i],s=u.from_string(t);u.missing(s)&&(n[i].hasMissing=!0),_.isUndefined(s)?(delete n[i],r.splice(e,1)):(n[i].array.push(s),e++)}}),n};var PRIORITIES=["number","date","datetime","boolean","string"];u$.choose_column_type=function(t){var n=Object.keys(t);if(1==n.length)return t[n[0]];for(var r=0;r<PRIORITIES.length;r++)if(t.hasOwnProperty(PRIORITIES[r]))return t[PRIORITIES[r]]};
	//# sourceMappingURL=out.map.js
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";function make_df_from_(t,e){return e=e||t.shift(),new DataFrame(t,e)}function parse_csv_to_array_of_rows(t){var e,n,r,a=[],o=!1;for(e=n=r=0;r<t.length;r++){var i=t[r],u=t[r+1];a[e]=a[e]||[],a[e][n]=a[e][n]||"",'"'===i&&o&&'"'===u?(a[e][n]+=i,++r):'"'!==i?","!==i||o?"\n"!==i||o?a[e][n]+=i:(++e,n=0):++n:o=!o}return a}function parse_dom_table_to_array_of_rows(t){return[].map.call(t.rows,function(t){return[].map.call(t.cells,function(t){return t.textContent})})}var u$=__webpack_require__(1),_=__webpack_require__(2),Column=function(t,e,n){this.name=t,this.data=[],e&&(this.data.length=e),this.type=n},ColumnSet=function(){this.byIndex=[],this.byName={}};ColumnSet.prototype.getColumn=function(t){return(_.isNumber(t)?this.byIndex:this.byName)[t]},ColumnSet.prototype.enforceColumn=function(t,e,n){var r=this.byName[t];return u$.isNullish(r)&&(r=new Column(t,e,n),r.col_idx=this.byIndex.length,this.byIndex.push(r),this.byName[t]=r),r},ColumnSet.prototype.enforceColumnAt=function(t,e,n){var r=this.byIndex[t];if(u$.isNullish(r)){var a="c"+t;r=new Column(a,e,n),r.col_idx=t,this.byIndex[t]=r,this.byName[a]=r}return r},ColumnSet.prototype.addColumns=function(t,e){for(var n=0;n<t.length;n++){var r,a=t[n];_.isPlainObject(t[n])&&(a=t[n].name,r=t[n].type),this.enforceColumn(a,e,r)}return this};var DataFrame=function(t,e){var n=this;if(_.isUndefined(n)||n.constructor!==DataFrame)return new DataFrame(t,e);t=t||[],this.columnSet=(new ColumnSet).addColumns(e||[],t.length),this.index=_.range(t.length);for(var r=0;r<t.length;r++){var a=t[r];if(_.isPlainObject(a))for(var o=Object.keys(a),i=0;i<o.length;i++)this.columnSet.enforceColumn(o[i]).data[r]=a[o[i]];else{if(!_.isArray(a))throw{msg:"row should be object or array and not:"+a};for(var u=0;u<a.length;u++)this.columnSet.enforceColumnAt(u).data[r]=a[u]}}return n};DataFrame.parse_csv=function(t,e){return make_df_from_(parse_csv_to_array_of_rows(t),e)},DataFrame.parse_dom_table=function(t,e){return make_df_from_(parse_dom_table_to_array_of_rows(t),e)},DataFrame.prototype.getRow=function(t,e){var n=this.index[t];return e=e||{},this.columnSet.byIndex.forEach(_.isArray(e)?function(t,r){e[r]=t.data[n]}:function(t){e[t.name]=t.data[n]}),e},DataFrame.prototype.get=function(t,e){var n=this.index[t],r=this.columnSet.getColumn(e);return r.data[n]},DataFrame.prototype.set=function(t,e,n){var r=this.index[t],a=this.columnSet.getColumn(e);a.data[r]=n},DataFrame.prototype.getRowCount=function(){return this.index.length},DataFrame.prototype.newRow=function(){var t=this.index.length;return this.index[t]=t,t},DataFrame.prototype.deleteRow=function(t){this.index.splice(t,1)},DataFrame.prototype.getColumn=function(t){var e=this.columnSet.getColumn(t);return e?this.index.map(function(t){return e.data[t]}):void 0},DataFrame.prototype.apply=function(t){for(var e=0;e<this.index.length;e++)t(this,e)},DataFrame.prototype.map=function(t){for(var e,n=[],r=0;r<this.index.length;r++)e=t(this,r),void 0!==e&&n.push(e);return n},DataFrame.prototype.getData=function(){for(var t={columns:[],rows:[]},e=this.columnSet.byIndex,n=0;n<e.length;n++){var r=e[n],a={name:r.name};r.type&&(a.type=r.type.name),t.columns.push(a)}return t.rows=this.map(function(t,e){return t.getRow(e,[])}),t},DataFrame.prototype.getObjects=function(){return this.map(function(t,e){return t.getRow(e)})},module.exports=DataFrame;
	//# sourceMappingURL=out.map.js
